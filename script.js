const projectsData = {
    "VERITAS": {
        ...
        content: `<h3>The Challenge</h3><p>In high-latency environments (like rural India or 3G networks), traditional cloud-based fact-checking is too slow (>1000ms), compromises user privacy by sending browsing data to central servers, and is inaccessible to 450M+ Indians lacking high-speed internet.</p>
    ...
    "EdgeDev": {
        ...
        content: `<h3>The Story</h3><p>Forged in the Teliamura Reserved Forest (Tripura, India), this project was built for developers operating under "Adversarial Network Conditions." It addresses extreme scarcity: 4G mobile hotspots, daily power grid cycles, and a strict 2GB daily data limit.</p>
    ...
    "Bhai-Lang": {
        ...
        content: `<h3>The Concept</h3><p>Writing print() is too mainstream. Built on the idea that "Bhai, code toh aise likhte hain!", this project creates a relatable coding experience for developers who think in Hinglish.</p>
    ...
    "Calyx": {
        ...
        content: `<h3>The Concept</h3><p>"The human mind is a garden. Calyx is the soil." This is a local prototype for an "Augmented Intelligence" system that treats memory as a network of connections rather than a list of files.</p>
    ...
    "Echo_Aid": {
        ...
        content: `<h3>The Purpose</h3><p>An "AI that listens between the lines." Echo_Aid is a mental wellness tool designed to help users recognize their own patterns of stress and vocal tone in real-time.</p>
